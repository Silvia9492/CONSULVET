export interface Veterinario {
  ...
  servicio: 'Vacunación' | 'Desparasitación' | 'Asesoramiento Nutricional' | 'Diagnóstico por Imagen' | 'TAC' | 'Resonancia Magnética' | 'Hospitalización' | 'Fisioterapia' | 'Cirugía general';
  email: string;
  centro_id: number;
}
